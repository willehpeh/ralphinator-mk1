...
- [x] Add delete() method to TaskAggregate (Commit: pending)
- [x] Add isDeleted getter to TaskAggregate (Commit: pending)
- [x] Add TASK_EVENT_TYPES.DELETED constant (Commit: pending)
