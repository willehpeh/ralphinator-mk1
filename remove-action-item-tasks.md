...
- [x] Add delete() method to ITaskReadRepository port (Already exists in interface)
...
- [x] Update TaskProjection to handle TaskDeletedDomainEvent (Commit: c37f93a)
- [ ] Write tests for TaskProjection.onTaskDeleted()

### Backend API
- [x] Add DELETE /api/tasks/:id endpoint to TasksController (Commit: e8cdbed)
- [ ] Test endpoint with HTTP client (curl/Postman)

### Frontend - NGRX State Management
- [x] Add deleteTask action to tasks.actions.ts (Commit: 4dee1d2)
- [x] Add deleteTaskSuccess action to tasks.actions.ts (Commit: 4dee1d2)
- [x] Add deleteTaskFailure action to tasks.actions.ts (Commit: 4dee1d2)
- [x] Add deleteTask$ effect to tasks.effects.ts (Commit: a955fc8)
- [x] Update tasksReducer to handle deleteTask actions (Commit: CURRENT)
- [x] Add deleteTask() method to TasksService (Commit: 4ec47f1)
