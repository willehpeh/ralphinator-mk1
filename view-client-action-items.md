...
- [x] Task 4: Add GET /api/clients/:id/tasks endpoint to ClientsController (COMPLETED - endpoint added at apps/api/src/app/clients/clients.controller.ts:146-151)
